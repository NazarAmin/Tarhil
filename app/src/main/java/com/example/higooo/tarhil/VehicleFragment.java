...
public class VehicleFragment extends Fragment implements OnMapReadyCallback, LocationListener {
  ...
  //  @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lm.requestLocationUpdates(LocationManager.GPS_PROVIDER,0,0, (LocationListener) VehicleFragment.this);
    ...
    private void initMap() {
        SupportMapFragment mapFragment = (SupportMapFragment) getFragmentManager().findFragmentById(R.id.mapv);
    ...
    public void onLocationChanged(Location location) {
        ...
        //  Toast.makeText(VehicleFragment.this,String.valueOf(longit),Toast.LENGTH_SHORT).show();
